...
<body>
	...
	<div id="top-image">
	<nav class="top-right">
	<a class="disc l1" href="${pageContext.request.contextPath}/requestin.action">
		<div>登陆</div>
	</a>
	<a class="disc l2" href="${pageContext.request.contextPath}/requestin.action#toregister">
		<div>注冊</div>
	</a>
	<a class="disc l3" href="${pageContext.request.contextPath}/autologin.action?user_name=${user_name}">
		<div>用户主页</div>
	</a>
	<a class="disc l4" href="${pageContext.request.contextPath}/help.jsp">
		<div>Help</div>
	</a>
		...
		<div id="content" class="container center-block">
			<div class="jumbotron">
				<div class="container">
					...
					<form action="${pageContext.request.contextPath}/searchfile.action"
						method="post">
